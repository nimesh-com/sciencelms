...
<div class="card card-primary">
    ...
    <form action="{{ route('lessons.update', $lesson->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <label for="slug">Google Drive Link</label>
                <input type="url" name="slug" class="form-control @error('slug') is-invalid @enderror" id="slug" placeholder="Enter Google Drive shareable link" value="{{ old('slug', $lesson->slug) }}">
